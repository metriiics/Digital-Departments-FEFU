...
Работы по очистке данных, кластеризации, регрессии и классификации с использованием различных методов машинного обучения (KMeans, DBSCAN, Decision Tree, SVM, Random Forest и др.).
